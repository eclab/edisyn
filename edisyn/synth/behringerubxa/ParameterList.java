...
public class ParameterList {
    ...
    public static final Object[] KeyToSysExPos = {
            "ControlPortamentoAmount", new int[]{0, 1, 5, 6},
            "ControlPortamentoBend", new int[]{2, 3, 4},
            "ControlDetune", new int[]{4, 5, 1, 2},
            "ControlVoiceDetune", new int[]{6, 7, 13, 0},
            "PerformanceVolume", new int[]{8, 9, 11, 12},
            "ModulationLFORate", new int[]{12, 13, 7, 8},
            "ModulationLFOPhase", new int[]{14, 15, 19, 20},
            "ModulationChannel1Amount", new int[]{16, 17, 18},
            "ModulationChannel2Amount", new int[]{18, 19, 15, 16},
            "EnvelopesFilterA", new int[]{20, 21, 27, 14},
            "EnvelopesFilterD", new int[]{22, 23, 25, 26},
            "EnvelopesFilterR", new int[]{26, 27, 21, 22},
            "EnvelopesLoudnessA", new int[]{28, 29, 33, 34},
            "EnvelopesLoudnessD", new int[]{30, 31, 32},
            "EnvelopesLoudnessS", new int[]{32, 33, 29, 30},
            "EnvelopesLoudnessR", new int[]{34, 35, 41, 28},
            "EnvelopesModChannel1A", new int[]{36, 37, 39, 40},
            "EnvelopesModChannel2A", new int[]{40, 41, 35, 36},
            "EnvelopesModChannel2Delay", new int[]{42, 43, 47, 48},
            "EnvelopesPedalR", new int[]{44, 45, 46},
            "OscillatorsOSC1PWAmount", new int[]{46, 47, 43, 44},
            "OscillatorsOSC1Transpose", new int[]{48, 49, 55, 42},
            "OscillatorsOSC2PWAmount", new int[]{50, 51, 53, 54},
            "FilterFrequency", new int[]{54, 55, 49, 50},
            "FilterResonance", new int[]{56, 57, 61, 62},
            "FilterModulation", new int[]{58, 59, 60},
            "FilterNoise", new int[]{60, 61, 57, 58},
            "ModMatrixBus1Amount", new int[]{62, 63, 69, 56},
            "ModMatrixBus2Amount", new int[]{64, 65, 67, 68},
            "ModMatrixBus4Amount", new int[]{68, 69, 63, 64},
            "ModMatrixBus5Amount", new int[]{70, 71, 75, 76},
            "ModMatrixBus6Amount", new int[]{72, 73, 74},
            "ModMatrixBus7Amount", new int[]{74, 75, 71, 72},
            "ModMatrixBus8Amount", new int[]{76, 77, 83, 70},
    };
}
