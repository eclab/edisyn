...
Edisyn has a large number of facilities to help you program your synthesizer, including tools to help you wander through the  space of possible patches to hunt for the sound you want.  Here's what you can do.
...
\item Mix Light Bias.  The child patch consists of 1/3 of the first (topmost) parent patch, with the remainder being 1/3 of the next parent, and so on.  The last two parents split their remainder fifty-fifty.
\item Mix Medium Bias.  The child patch consists of 1/2 of the first (topmost) parent patch, with the remainder being 1/2 of the next parent, and so on.  The last two parents split their remainder fifty-fifty.
\item Mix Heavy Bias.  The final patch consists of 2/3 of the first (topmost) parent patch, with the remainder being 2/3 of the next parent, and so on.  The last two parents split their remainder fifty-fifty.
...
\paragraph{Renaming Patches}  Select a patch and press Return.  If the patch can be renamed in place, the patch's name editor will pop up.
