...
We have a public beta for the Waldorf M ("Final" 1.09 firmware only).  If you'd like to try it out, Beta 7 (Edisyn.app and edisyn.jar files) [can be found here](http://robo1.cs.gmu.edu/edisyn.m.beta7.zip).  Be sure to read the rest of this page to learn how to install those files.  Also be sure to read the README file which accompanies them.
