...
Finally, if you don't have a controller keyboard, you can send a test note to your synthesizer by choosing {\bf Send Test Note}.  You can also toggle whether Edisyn constantly sends a stream of test notes by choosing {\bf Send Test Notes}.  You can choose the length of the test notes you send in the {\bf Test Note Length} submenu.  And you can shut off all sound on the synthesizer with {\bf Send All Sounds Off}.
...
\item{5--8}: Four more noisy versions of the current patch
\item{9--12}: Four very noisy versions of the current patch
