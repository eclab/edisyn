...
public class YamahaFB01 extends Synth
    ...
    public static final ImageIcon[] WAVE_ICONS = 
        {
        new ImageIcon(YamahaFB01.class.getResource("Wave1.png")),
        new ImageIcon(YamahaFB01.class.getResource("Wave2.png")),
        new ImageIcon(YamahaFB01.class.getResource("Wave3.png")),
        new ImageIcon(YamahaFB01.class.getResource("Wave4.png")),
        new ImageIcon(YamahaFB01.class.getResource("Wave5.png")),
        new ImageIcon(YamahaFB01.class.getResource("Wave6.png")),
        new ImageIcon(YamahaFB01.class.getResource("Wave7.png")),
        new ImageIcon(YamahaFB01.class.getResource("Wave8.png"))
        };
    ...
    */
    ...
    public Object[] emitAll(String key)
        ...
        if (key.equals("name"))
            ...
            {
            System.err.println("Warning (YamahaFB01): Can't emit key " + key);
            return new Object[0];
            }
        }
    ...
    int subparse(byte[] data, boolean fromFile)
        ...
        if (data.length == 101 &&       // 93 + 8 byte wrapper
            ...
            {
            System.err.println("Warning (YamahaFB01): Can't parse data (length " + data.length + ").  First bytes:");
            int len = 16;
            if (len > data.length) 
                len = data.length;
            for(int i = 0; i < len; i++)
