...
So you need to understand that you'll probably have to do a lot of customization.  I've tried to provide many customization options in Edisyn.  If you need something Edisyn doesn't provide, contact me.

\subsection{Step Two: Set Up the Development Environment}

Probably the easiest way to fire up Edisyn for purposes of testing is as a build directory.  You just need to add two items to your CLASSPATH:
...
Still not scared away?  Okay, here's where we start.  Let's say you're adding a single (non-multimode) patch editor for the Yamaha DX7.
...
\subsection{Step Nine: Other Niceties}
