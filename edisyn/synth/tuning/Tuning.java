...
public class Tuning extends Synth
{
	...
	static TuningDefinition[] namedScales = {
		...
		new RepeatingScale(new double[] { 0.000, 70.673, 203.910, 315.641, 386.314, 498.045, 568.718, 701.955, 772.628, 884.359, 1017.596, 1088.269, 1200},
		                   "Pure Major"),
		new RepeatingScale(new double[]{ 0.000, 70.673, 182.404, 315.641, 384.314, 498.045, 568.718, 701.955, 772.628, 884.359, 1017.596, 1088.269, 1200},
		                   "Pure Minor"),
		new RepeatingScale(new double[]{ 0.000, 113.685, 203.910, 294.135, 407.820, 498.045, 611.730, 701.955, 815.640, 905.865, 996.090, 1109.775, 1200},
		                   "Pythagorean"),
		new RepeatingScale(new double[] { 0.000, 90.225, 192.180, 294.135, 390.225, 498.045, 588.270, 696.090, 792.180, 888.270, 996.090, 1092.180, 1200},
		                   "Werkmeister"),
		new RepeatingScale(new double[] { 0.000, 90.225, 193.157, 294.135, 386.314, 498.045, 590.224, 696.578, 792.180, 889.735, 996.090, 1088.269, 1200},
		                   "Kirnberger"),
		new RepeatingScale(new double[]{ 0.000, 94.135, 196.090, 298.045, 392.180, 501.955, 592.180, 698.045, 796.090, 894.135, 1000.000, 1090.225, 1200},
		                   "Vallotti and Young"),
		new RepeatingScale(new double[]{0, 146.30, 292.61, 438.91, 585.22, 731.52, 877.83, 1024.13, 1170.44, 1316.74, 1463.05, 1609.35, 1755.66, 1901.96},
