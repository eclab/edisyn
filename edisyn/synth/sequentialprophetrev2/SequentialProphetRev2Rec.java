...
public class SequentialProphetRev2Rec extends Recognize
    {
    ...
    public static boolean recognize(byte[] data)
        ...
        // System.err.println("Warning (Prophet Rev2): Unknown program data format " + data.length);
        return ((data.length == 2346 &&
                data[0] == (byte)0xF0 &&
