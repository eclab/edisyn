...
public class OberheimMatrix1000Global extends Synth
    ...
    public JComponent addVibrato(Color color)
        ...
        params = MOD_SOURCES;
        comp = new Chooser("Speed Source", this, "vibratospeedmodsourcecode", params);
        vbox.add(comp);

        params = MOD_SOURCES;
        comp = new Chooser("Amplitude Source", this, "vibratoampmodsourcecode", params);
        vbox.add(comp);
        hbox.add(vbox);
    ...
    public JComponent addMIDI(Color color)
        ...
        ((LabelledDial)comp).addAdditionalLabel("Controller");
        hbox.add(comp);
    ...
    public JComponent addGeneral(Color color)
        ...
        comp = new LabelledDial("Bend Range", this, "bendrange", color, -24, 24);	// the docs say 1 bit, which is obviously wrong
        hbox.add(comp);
        category.add(hbox, BorderLayout.WEST);
        return category;
        }
