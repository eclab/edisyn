...
\item {\it Load} all of the patches matching a current synth type into the this editor's {\bf Librarian} (Section~\ref{librarian}) or into a new librarian.  Note that if these are bank patches, their individual patches will be loaded into the librarian: and they may overwrite other bank patches also being loaded.s
\end{itemize}
...
\begin{wrapfigure}{r}{3.6in}
\vspace{-4.5em}\includegraphics[scale=0.27]{ConstrictorPanel.png}
\vspace{-3em}
